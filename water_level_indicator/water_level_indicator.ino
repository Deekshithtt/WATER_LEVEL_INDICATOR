...
#define BLYNK_AUTH_TOKEN "VH-6nTZ0N_YPao3iic1JmaZQr27PaVSR"
...
int emptyTankDistance = 25 ;  //Distance when tank is empty
int fullTankDistance =  5 ;  //Distance when tank is full (must be greater than 25cm)
